...
import { PositionAbsolute } from "./Positions";
import { PositionFixed } from "./Positions";
...
export default function Lab2() {
  return (
    <Container>
      ...
      <Link href="/labs/lab2/tailwind" id="wd-tailwind-link">Tailwind</Link>
