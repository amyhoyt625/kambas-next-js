    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Make rice in rice cooker.</li>
          <li>Slice favorite veggies.</li>
          <li>Heat a skillet.</li>
          <li>Saute veggies in pan till al dente.</li>
          <li>Then fry an egg.</li>
          <li>Add all ingerdients to a bowl.</li>
          <li>Top with your favorite gochugang sauce.</li>
          <li>Stir to combine.</li>
          <li>Serve and enjoy!</li>
        </ol>
      ...
      <br />
      Please
      <a href="https://github.com/amyhoyt625" id="wd-github">
        {" "}
        click here{" "}
      </a>
      to get to my github
