...
export default function TOC() {
  ...
  return (
    <Nav variant="pills">
      ...
      <NavItem>
        <NavLink href="https://github.com/amyhoyt625">My GitHub</NavLink>
      </NavItem>
      <NavItem>
        <NavLink href="https://github.com/amyhoyt625/kambaz-node-server-app">
          Node Server GitHub
        </NavLink>
      </NavItem>
      <NavItem>
        <NavLink href="https://kambaz-node-server-app-bnzg.onrender.com">
